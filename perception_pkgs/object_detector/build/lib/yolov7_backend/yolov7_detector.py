...
sys.path.append(os.getcwd()+'/src/object_detector/src/yolov7_backend/yolov7')
print(sys.path)
import rospy
...
class YOLO7_Detector:
    def __init__(self):
        ...
        model_weights = attempt_load('/home/administrator/ITTSorting/src/object_detector/src/yolov7_backend/yolov7.pt')
